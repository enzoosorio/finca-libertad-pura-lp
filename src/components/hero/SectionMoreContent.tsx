  ...
  return (
    <section className="py-12 font-body">
      <ul className="flex flex-col items-center p-0 ">
        <li ref={item1Ref} className="w-full mx-auto bg-[rgba(43,88,178,0.3)]">
          <div className='w-full h-[550px]  flex items-center justify-center  mx-auto'>
            <div className="flex w-full flex-col items-start justify-center gap-2  ">
              <div className='w-max  mx-auto flex flex-col items-start justify-center gap-4'>
                ...
                <div className='flex flex-col font-roboto font-light  lg:flex-row items-start justify-center gap-4   '>
                  <p className="w-72 2xl:text-lg">En Finca Libertad Pura vivimos y compartimos la esencia de Costa Rica: un espacio de naturaleza, tradición y familia, donde cada visita se convierte en una experiencia auténtica y memorable. Nuestro compromiso es brindar turismo rural sostenible que une hospitalidad, cultura y paisajes únicos, para que cada persona se sienta parte de nuestra historia.</p>
                  <p className="w-72 2xl:text-lg">Nos enfocamos en presentar la sencillez del campo costarricense, cultivando momentos de unión, aprendizaje y respeto por la naturaleza. Más que un destino, somos un hogar abierto donde se celebra la vida, la tradición y la libertad en su forma más pura.</p>
                </div>
              </div>
            </div>
        ...
        <li ref={item2Ref} className="w-full mx-auto bg-[rgba(31,152,90,0.3)]">
          <div className='w-full h-[600px]  flex items-center justify-center flex-row-reverse  mx-auto'>
            <div className="flex w-full  flex-col items-start justify-center gap-2 ">
              <div className='w-max  mx-auto flex flex-col items-start justify-center gap-4'>
                <div className="w-full flex flex-col items-start justify-start gap-2 ">
                ...
                <p className="w-[60ch] 2xl:text-lg font-roboto font-light">Los caballos son el alma de nuestra finca. 
            ...
            <div className="relative w-full h-full overflow-hidden">
              <img ref={img2Ref} className="absolute top-0 left-0 w-full min-h-[120%] object-cover object-top" src="/images/Hero/Finca-caballos.png" alt="" />
            </div>
          </div>
        </li>
      </ul>
