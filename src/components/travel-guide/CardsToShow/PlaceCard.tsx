...
export const PlaceCard = ({ place }: PlaceCardProps) => {
  return (
    <div className="relative flex flex-col sm:flex-row items-center justify-center gap-4 bg-white rounded-md shadow-lg p-4 ">
      ...
      <div className="flex flex-col items-start justify-start sm:justify-center w-full sm:w-auto flex-1">
        <h3 className="text-sm font-semibold font-body w-[80%] sm:w-full">
          {place.place}
        </h3>
